 ...
 */
public class IndexConfigurationIndexTextIndexDefinition extends IndexConfigurationIndex {
  ...
  public static class Builder {
    ...
    public Builder(IndexConfigurationIndex indexConfigurationIndexTextIndexDefinition) {
      this.defaultAnalyzer = indexConfigurationIndexTextIndexDefinition.defaultAnalyzer;
      this.defaultField = indexConfigurationIndexTextIndexDefinition.defaultField;
      this.indexArrayLengths = indexConfigurationIndexTextIndexDefinition.indexArrayLengths;
      this.partialFilterSelector = indexConfigurationIndexTextIndexDefinition.partialFilterSelector;
      this.fields = indexConfigurationIndexTextIndexDefinition.fields;
    }
    ...
    /**
     * Builds a IndexConfigurationIndexTextIndexDefinition.
     *
     * @return the new IndexConfigurationIndexTextIndexDefinition instance
     */
    public IndexConfigurationIndexTextIndexDefinition build() {
      return new IndexConfigurationIndexTextIndexDefinition(this);
    }
     ...
     * @return the IndexConfigurationIndexTextIndexDefinition builder
     */
  ...
  protected IndexConfigurationIndexTextIndexDefinition(Builder builder) {
   ...
   * New builder.
   *
   * @return a IndexConfigurationIndexTextIndexDefinition builder
   */
